""" converts the orthomcl groups.txt output to presence-abscence table


Usage:
  groups2table.py -o <outfile> -i <groups.txt>
  groups2table.py -h
  
Options:
    -o <outfile>    name of output files
    -i <groups.txt>   name of the txt file describing the clusters
"""
